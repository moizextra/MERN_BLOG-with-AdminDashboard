...
function Navbar() {
  ...
  const navClass = `flex items-center justify-between flex-wrap bg-gray-800 p-6 border-b-4 border-yellow-500 ${
    expand ? 'h-16' : ''
  }`;
  ...
  return (
    <nav className={navClass}>
      ...
      <div className="block lg:hidden">
        <button onClick={handleclick} className="flex items-center px-3 py-2 border rounded text-gray-200 border-gray-700 hover:text-white hover:border-white">
